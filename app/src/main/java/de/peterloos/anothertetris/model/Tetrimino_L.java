...
/**
 * Created by Peter on 16.10.2015.
 */
public class Tetrimino_L extends Tetrimino {

    // c'tor
    public Tetrimino_L(ITetrisBoard board) {
        super(board, CellColor.Ocker);
    ...
    public boolean CanSetToTop() {
        ...
        return !(this.board.getCell(this.anchorPoint.getY() - 1, this.anchorPoint.getX()).getState() == CellState.Used ||
